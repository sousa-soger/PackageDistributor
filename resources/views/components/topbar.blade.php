            ...
            <div
                ...
                @if(Auth::user()->github_id)
                    <form method="POST" action="{{ route('github.oauth.disconnect') }}">
                        ...
                        <button type="submit" role="menuitem" tabindex="-1"
                            ...
                            <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-md border border-border/60 bg-secondary/60 text-muted-foreground">
                            ...
                            <span class="inline-flex shrink-0 items-center gap-1.5 rounded-md border border-success/30 bg-success/10 px-2 py-0.5 text-[10px] font-medium text-success">
                ...
                @else
                    <a href="{{ route('github.oauth.redirect') }}" role="menuitem" tabindex="-1"
                        ...
                        <span class="inline-flex shrink-0 items-center gap-1.5 rounded-md border border-border/60 bg-muted/60 px-2 py-0.5 text-[10px] font-medium text-muted-foreground">
