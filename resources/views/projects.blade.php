                                            ...
                                            <table class="w-full text-sm">
                                                <thead class="border-b border-slate-100 bg-slate-50">
                                                    <tr>
                                                        ...
                                                        <th class="text-left px-4 py-2.5 text-xs font-semibold text-slate-500 uppercase tracking-wide">Expiration</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="divide-y divide-slate-100">
                                                    <template x-for="m in members" :key="m.id">
                                                        <tr class="hover:bg-slate-50 transition-colors">
                                                            ...
                                                            <td class="px-4 py-3 text-xs text-slate-500" x-text="formatDate(m.expires_at)"></td>
                                                        </tr>
                                                    </template>
                                                </tbody>
                                            </table>
